...
import api.endpoint.UserEndPointProperyFile;
...
public class UserTestRoutes {
	...
	public void testCreateUser() {
		...
		//pass the payload
		Response res=UserEndPointProperyFile.createUser(user);
		res.then().log().all();
	...
	public void testGetUser() {
		...
		Response res=UserEndPointProperyFile.getUser(this.user.getUsername());
		res.then().log().all();
		Assert.assertEquals(res.getStatusCode(), 200);
	...
	public void testUpdateUser() {
		...
		Response res=UserEndPointProperyFile.updateUser(user,this.user.getUsername());
		...
		Response responsePostUpdate=UserEndPointProperyFile.getUser(this.user.getUsername());
	...
	public void testDeleteUserByName() {
		...
		Response res=UserEndPointProperyFile.deleteUser(this.user.getUsername());
		Assert.assertEquals(res.getStatusCode(), 200);
